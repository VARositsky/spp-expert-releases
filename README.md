...
**СПП-Эксперт** — цифровая платформа для подготовки производственного персонала к проверке знаний и аттестации.

Ключевая особенность платформы — работа с **локальными билетами конкретных подразделений**. Сотрудник может готовиться с компьютера или мобильного устройства, получать мгновенную обратную связь по ответам и обращаться к связанным нормативным материалам.

Платформа включает инструменты как для сотрудников, проходящих подготовку, так и для администраторов, отвечающих за актуализацию учебного контента.
...
Платформа использовалась при подготовке участников студенческого отряда и получила положительные отзывы сотрудников и руководителей подразделений ПАО «Россети Ленэнерго».

- 📄 [Отзывы руководства и специалистов СПбВС](docs/management-reviews.pdf)
- 📄 [Отзывы участников студенческого отряда 2026](docs/student-team-reviews-2026.pdf)
...
- импорт и экспорт локальной базы.

---

## Скачать

Готовые сборки публикуются в разделе **Releases**.
